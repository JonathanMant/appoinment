...
$sql=("select cita.idcita,cita.hora,cita.fecha,cita.especialidad,cita.cedula_paciente,cita.cedula_medico from login,medico,agenda,cita where login.id='$idd'
and login.id=medico.id
