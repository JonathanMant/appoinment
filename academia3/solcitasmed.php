...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
        ...
        $sql="SELECT cita.idcita,cita.cedula_paciente, cita.cedula_medico, cita.idAgenda FROM login, paciente, cita where login.id='$ida' and login.id=paciente.id and paciente.cedula_paciente=cita.cedula_paciente";

    //la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
        $ressql=mysqli_query($mysqli,$sql);
        while ($row=mysqli_fetch_row ($ressql)){
                $idcita=$row[0];
                $cedula_paciente=$row[1];
                $cedula_medico=$row[2];
                $idAgenda=$row[3];
        ...
        <form action="Solicitarcita.php" method="post">
                idcita<br><input type="text" name="idcita"readonly="readonly"><br>
                *hora<br> <input type="text" name="hora"><br>
                *fecha<br> <input type="text" name="fecha"><br>
                *especialidad<br> <input type="text" name="especialidad"><br>
            cedula_pacientess<br> <input type="text" name="cedula_paciente" value="<?php echo $cedula_paciente?>"><br>
