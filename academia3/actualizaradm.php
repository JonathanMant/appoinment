...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		$sql="SELECT * FROM cita WHERE cedula_paciente=$idaa";
	//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
		...
		<form action="ejecutaadm.php" method="post">
			...
			cedula_pacientes<br> <input type="text" name="cedula_paciente" value="<?php echo $cedula_paciente?>"><br>
				cedula_medico<br> <input type="text" name="cedula_medico" value="<?php echo $cedula_medico?>"><br>
