...
<body background="images/medico.jpg" style="background-attachment: fixed" >
	<center><div class="tit"><h2 style="color: #424242; ">Inicio de sesión</h2>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="password" name="contraseña" class="form-control"  placeholder="Ingresa contraseña" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Repite tu contraseña</b></label>
      <input type="password" name="rContraseña" class="form-control" required placeholder="repite contraseña" />
    </div>
